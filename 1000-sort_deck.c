...
/**
 * get_value - a function that gets the numerical value of a card.
...
/**
 * insertion_sort_deck_kind - a function that sorts a deck
...
/**
 * sort_deck - a function that sorts a deck of cards from ace
 * to king and from spades to diamonds.
 * @deck: pointer to the head of a deck_node_t doubly-linked list.
 */
